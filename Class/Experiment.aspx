                            ...
                            <div class="title-box" id="title-box-<%= i %>">
                                ...
                                <%
                                    ...
                                    <% }
                                        ...
                                        {
                                            Session["ThatCourseExperiment"+courseExperiment.CourseExperimentId] = courseExperiment;
                                    %>
                                        <!-- 提交实验报告 -->
                                        <%--用a标签，href=javascript:,onclick为js弹出窗口的代码--%>
                                        <a class="btn btn-primary more-info" href="javascript:"
                                           onclick="window.open('UploadFile.aspx?ceid=<%= courseExperiment.CourseExperimentId %>', 'popup_window', 'width=600,height=200,left=100,top=100,resizable=yes');">
                                            上传实验报告
                                        </a>
                                        <!-- 提交作业-->
                                <%
